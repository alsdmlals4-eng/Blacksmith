...
class PlanningFirstCompatibilityTests(unittest.TestCase):
    ...
    def test_batch_005_is_active_at_one_of_ten(self) -> None:
        self.assertEqual("R2_BATCH_005_ACTIVE_1_OF_10", self.registry["stage_status"])
        ...
        self.assertEqual(["BS-CRAFT-20260805-02"], active["decisions"])
    ...
    def test_current_entrypoints_are_truthful(self) -> None:
        ...
        self.assertIn("R2_BATCH_005_1_OF_10", game_bible)
        self.assertIn("R2_BATCH_005_1_OF_10", active)
        self.assertIn("R2_BATCH_005 / 1/10", root)
