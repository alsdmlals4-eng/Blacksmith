...
class PlanningFirstCompatibilityTests(unittest.TestCase):
    ...
    def test_batch_005_is_active_at_four_of_ten(self) -> None:
        ...
        self.assertEqual(["BS-CRAFT-20260805-02", "BS-CUSTOMER-20260805-01", "BS-UX-20260805-01", "BS-CUSTOMER-20260806-01"], active["decisions"])
    ...
    def test_current_entrypoints_are_truthful(self) -> None:
        ...
        self.assertIn("R2_BATCH_005_4_OF_10", game_bible)
        self.assertIn("R2_BATCH_005_4_OF_10", active)
        self.assertIn("R2_BATCH_005 / 4/10", root)
