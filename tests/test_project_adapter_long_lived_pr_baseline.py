...
CURRENT_DELIVERY_RECEIPT = ROOT / "docs/operations/receipts/2026-09-13-five-equipment-world-use.json"
...
class LongLivedPrAdapterBaselineContractTests(unittest.TestCase):
    ...
    def test_handoff_records_post_visual_delivery_contract_recovery(self) -> None:
        ...
        self.assertIn("ORDINARY_ENTRY_GATE_RESTORATION_ISSUE_301", text)
