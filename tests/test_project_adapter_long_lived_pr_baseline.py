...
OPERATING_CONTRACT_BASELINE = "8347a59af49916f06503adcd4e28db3db8b26e49"
...
class LongLivedPrAdapterBaselineContractTests(unittest.TestCase):
    ...
    def test_workshop_enhancement_ui_protected_change_approval_is_current(self) -> None:
        adapter = json.loads(ADAPTER.read_text(encoding="utf-8"))
        self.assertEqual("8347a59af49916f06503adcd4e28db3db8b26e49", adapter["protected_baseline"]["commit"])
        approval = json.loads(
        ...
        self.assertIn("GITHUB-ISSUE-253", approval["decision_ids"])
