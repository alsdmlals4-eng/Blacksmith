...
CURRENT_VERSION_DECISION_ID = "BS-TOOLCHAIN-20260826-33"
...
def test_current_policy_records_approved_editor_plugins_without_expanding_authority() -> None:
    ...
    assert higodot["installed_plugin_version"] == "3.2.0"
...
def test_current_upstream_320_retires_task2_raw_main_scene_overlay_and_keeps_generic_guard() -> None:
    policy = _policy()
