...
R3_CURRENT_DECISION_ID = "BS-CONTENT-20260811-06"
R3_CURRENT_RESUME_LOCATOR = "NOBLE_01_HEIRLOOM_SUCCESSION_RESTORATION_APPROVED"
...
def test_current_decision_router_preserves_task2_technical_baseline_and_r3_scope() -> None:
    ...
    assert "R3_R7_APPROVAL_COUNTER: 6/10" in current
    assert R3_THIRD_DECISION_ID in text
