...
R3_CURRENT_DECISION_ID = "BS-CONTENT-20260811-05"
R3_CURRENT_RESUME_LOCATOR = "GLADIATOR_01_CASSIA_ARENA_SIGNATURE_WEAPON_APPROVED"
...
def test_current_decision_router_preserves_task2_technical_baseline_and_r3_scope() -> None:
    ...
    assert "R3_R7_APPROVAL_COUNTER: 5/10" in current
    assert R3_THIRD_DECISION_ID in text
