...
- `BS-CRAFT-20260804-02`: 예술성 `1~10` 기반
...
- `BS-CRAFT-20260805-01`: 예술성을 단계명 없는 숫자형 무기·작품 능력치로 확정
...
- `전설`은 예술성 10·촉매 수식어·연대기 수식어·보편 최강 성능을 보장하지 않음
...
기존 임시 `BASIC / REFINED / MASTERWORK / MASTERPIECE` 단계 프리셋은 `[대체됨]`이며 숫자 `1~10`만 현재 권위다.
