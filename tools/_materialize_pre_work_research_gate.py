...
decision_path = Path("docs/decisions/BS-OPS-20260811-02_PRE_WORK_RESEARCH_GATE.md")
...
Path(".github/workflows/pre-work-research-gate-materialize.yml").unlink()
Path("tools/_materialize_pre_work_research_gate.py").unlink()
