...
REQUIRED_ASSERTIONS = {
    ...
    "docs/planning/CURRENT_R2_CANON_REGISTRY.json": (
        ...
        '"persisted_stat":"ARTISTRY"',
        '"valuation_model":"ADDITIVE_COMPONENTS_WITH_PIECEWISE_DIMINISHING_MARGINAL_VALUE"',
        '"customer_interest_roles":["IGNORE","SECONDARY","PRIMARY","REQUIREMENT"]',
        '"current_artistry_model":"NON_NEGATIVE_INTEGER_NO_FIXED_DESIGN_MAXIMUM_NO_NAMED_TIERS"',
        '"current_artistry_generation_growth_valuation_model":"SOURCE_LIMITED_CONTEXT_DERIVED_PIECEWISE_DIMINISHING"',
