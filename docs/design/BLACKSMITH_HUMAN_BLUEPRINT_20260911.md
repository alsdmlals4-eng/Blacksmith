# 모루의 서약
사람용 통합 블루프린트 / 2026.09.11 / 최종 검토용
...
![대장장이 망치 동작 후보 시트 / 프레임 연속성 검수 전에는 완성 모션 아님](candidates/blueprint-20260911/smith.png)
...
| 대장장이8포즈 | 투명 시트 | 1774×887은4×2 정수셀이 아님, 모루/발 정렬 필요 | 공방 타격 루프 |
