...
| Asset Library | `3c01b237-eb1c-817a-b257-cf6e2d299896` | `CURRENT_MAPPED` | `assets/ASSET_MANIFEST.json`; `docs/planning/BLACKSMITH_VISUAL_GDD_ASSET_APPROVAL_2026-08-25.md`; historical binary archive below |
...
The eight previously approved Visual GDD originals were downloaded from their Notion page attachments, then checked against the pre-existing GitHub approval manifest. They are now stored under `assets/visual_reference/historical_notion_gdd/`.

| Visual ID | Repository copy | Preservation state |
| --- | --- | --- |
| `BS-VIS-20260820-01` | `assets/visual_reference/historical_notion_gdd/BS-VIS-20260820-01_enhancement_main_visual_gdd.png` | `HISTORICAL_REFERENCE_ONLY_NOT_RUNTIME` |
| `BS-VIS-20260820-02` | `assets/visual_reference/historical_notion_gdd/BS-VIS-20260820-02_feedback_ladder_visual_gdd.png` | `HISTORICAL_REFERENCE_ONLY_NOT_RUNTIME` |
| `BS-VIS-20260820-04` | `assets/visual_reference/historical_notion_gdd/BS-VIS-20260820-04_tension_band_visual_gdd.png` | `HISTORICAL_REFERENCE_ONLY_NOT_RUNTIME` |
| `BS-VIS-20260820-05` | `assets/visual_reference/historical_notion_gdd/BS-VIS-20260820-05_first_ten_minutes_storyboard_visual_gdd.png` | `HISTORICAL_REFERENCE_ONLY_NOT_RUNTIME` |
| `BS-VIS-20260820-06` | `assets/visual_reference/historical_notion_gdd/BS-VIS-20260820-06_current_max_durability_visual_gdd.png` | `HISTORICAL_REFERENCE_ONLY_NOT_RUNTIME` |
| `BS-VIS-20260820-08` | `assets/visual_reference/historical_notion_gdd/BS-VIS-20260820-08_max_scar_visual_gdd.png` | `HISTORICAL_REFERENCE_ONLY_NOT_RUNTIME` |
| `BS-VIS-20260820-09` | `assets/visual_reference/historical_notion_gdd/BS-VIS-20260820-09_repair_decision_visual_gdd.png` | `HISTORICAL_REFERENCE_ONLY_NOT_RUNTIME` |
| `BS-VIS-20260824-10` | `assets/visual_reference/historical_notion_gdd/BS-VIS-20260824-10_precision_customer_visual_gdd.png` | `HISTORICAL_REFERENCE_ONLY_NOT_RUNTIME` |
