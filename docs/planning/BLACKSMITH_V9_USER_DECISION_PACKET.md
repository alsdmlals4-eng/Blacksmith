...
사용자는 2026-07-31에 아래 권장안과 작업 원칙을 채택했다.
...
벤치마킹 후 다음 기본안을 마스터 기획에 통합했다.

- 불씨 정령: `모닥`
- 대표 검투사: `카시아 벨란`
- +50 진화: `성벽파쇄`, `용광의 심장`, `투기장의 맹세`
- 계보 수식어 6종
- 보조 수식어 10종
- 수집가: `에르사 로엔`
- 수집가 대표 작품: `별철 의식 방패`
- 첫 5분 튜토리얼과 장비·고객·연대기 정보 위계
- Android 기준 기기군과 48dp 터치 기준
- 명작 전당의 검증·레거시·시즌·공개·삭제 정책

상세 내용은 `BLACKSMITH_P1_CONTENT_UX_BENCHMARK_AND_DESIGN_2026.md`를 따른다.

## 12. 다음 단계

1. 기존 강화·경제·보호 정본과 P1 기본안의 전파 정합성 확인
2. 수식어 중복·상충과 +50 진화 선택 우열 검토
3. 카시아 승패 결과와 수집가 전시 결과를 데이터 규칙으로 정리
4. 첫 5분 실제 화면 단위 UX 플로우 작성
5. 전체 기획 적대적 검수
6. 사용자 `기획 완료`
7. Google Sheet 동기화
8. 사용자 `검수 완료`
