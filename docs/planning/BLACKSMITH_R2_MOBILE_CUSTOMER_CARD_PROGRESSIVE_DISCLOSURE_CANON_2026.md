...
일반 앱처럼 상세를 단순히 숨기는 데 그치지 않는다. 게임에서는 작품을 선택하는 순간 **중량 상태·예상 성공률·핵심 원인 2~4개**가 즉시 나타나야 한다. 따라서 단계적 공개를 의사결정 피드백과 결합한다.
...
<!-- ACTIVE_BATCH_REFINED_BY_BS-CUSTOMER-20260806-01 -->
