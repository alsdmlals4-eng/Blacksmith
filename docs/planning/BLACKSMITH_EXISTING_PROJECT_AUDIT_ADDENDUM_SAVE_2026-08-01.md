...
1. P0-2 제작 등급·수식어·+50 저장 마이그레이션
2. P0-3 고객 4유형과 관계·소유권 Snapshot
3. P0-4 자동 단조와 비가역 저장 경계
4. P1 Android lifecycle·뒤로가기·설정 영속성 상세
5. 구현 계획 전 validator·fixture·E2E 시나리오 정리
