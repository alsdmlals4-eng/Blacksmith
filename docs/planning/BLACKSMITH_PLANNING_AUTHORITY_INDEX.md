...
- `KEYWORD_OWNERSHIP_FIELD_OWNER = BS-ENHANCE-20260828-34`; Decision34 overrides the Core Canon for keyword-ownership fields. Tag identity is owned by catalyst lineage; Precision method is limited to weapon stats and durability.
