...
- Current Base adaptation / work-contract owner: `docs/operations/BLACKSMITH_BASE_CURRENT_ADAPTATION_WORK_CONTRACT_20260901.md` — Base current observation and project work routing only; it cannot replace product Decision field owners, update the adapter pin automatically, or authorize new product scope.
...
BS-ART-20260825-03
BS-ART-20260826-04
BS-ENHANCE-20260830-38 = RECURRING_PRECISION_FIELD_OWNER
BS-ENHANCE-20260901-40 = CONSUMABLE_PRECISION_CATALYST_RESOURCE_FIELD_OWNER
Decision34/37 = RESIDUAL_NON_CONFLICTING_HISTORICAL_EVIDENCE
```
