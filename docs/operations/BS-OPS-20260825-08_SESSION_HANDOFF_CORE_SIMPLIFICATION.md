...
- Current approved Slice: `CURRENT_PHASE_1_SLICE = B_ENHANCEMENT_FIRST_SAME_UID_LIFECYCLE`; `PHASE_1_ENHANCEMENT_WINDOW = +0_TO_+10 + +11_TO_+15` before one same-UID customer actual-use result; `PHASE_1_TARGET_SESSION_DURATION = 6_TO_8_MINUTES`. It is a playtest experience hypothesis, not a runtime timer. Exact timing and economy remain Phase-1 review inputs.
