...
> 2026-09-10 resume: `docs/design/BLACKSMITH_PIXEL_WORLD_BLUEPRINT_20260910.md` is the current pixel-replan/world-window design owner. Its checklist separates source/research/design preparation from pending new assets, Aseprite task verification, save migration and runtime. Next safe work: consumer-specific forge/duel briefs and candidates; no old assets or saves deleted, no product paths changed. Base lock remains v9.4.4.
