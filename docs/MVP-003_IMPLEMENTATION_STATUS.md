...
|---:|---|---|---|
| 1 | lifecycle JSON 4종, validator, Python 계약 테스트 | 완료 | PASS |
| 2 | `WorkshopCalendar`, 피로도·날짜 단위 테스트 | 완료 | PASS |
| 3 | 영구 완성도 Resolver, legacy 변환 테스트 | 완료 | PASS |
| 4 | 검투사 계약·적합도 모델과 테스트 | 완료 | PASS |
| 5 | 세계 Registry·결정적 결과 Resolver와 테스트 | 완료 | PASS |
| 6 | 제작·강화·납품 원자 거래, Controller 통합 테스트 | 완료 | PASS |
| 7 | 로컬 PoC telemetry와 테스트 | 완료 | PASS |
| 8 | 계약·HUD·제작·강화·보고·재방문 세로 UI, 접근성 보조 | 완료 | Scene smoke PASS / 사람 검토 NOT_RUN |
| 9 | 전체 생애 E2E, CI 최적화, 정본 동기화 | 완료 | E2E·정본 PASS |
...
최신 Green PR validation에서 다음이 통과했다.
