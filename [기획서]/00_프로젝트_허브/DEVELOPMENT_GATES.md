...
SHEET_CANON_ALIGNMENT_GATE: PR94_MERGE_SHA_FINALIZATION_PENDING
...
판정: `PASS / USER_APPROVED / MERGED_PR94`.
...
R1~R8 기획·검수, GitHub·Sheet 동기화, 테스트 프리셋·rollback 계약이 완료되기 전까지 `BLOCKED`다.

## Current Next Gate

```yaml
NEXT_ACTIVITY: SYNC_PR94_MERGE_SHA_AND_REQUEST_USER_R1_FINAL_REVIEW
