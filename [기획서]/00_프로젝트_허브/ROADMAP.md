...
CURRENT_STAGE_STATUS: R3_R7_4_OF_10_USER_APPROVED_PLANNING_ONLY
...
`BS-CONTENT-20260811-01`부터 `BS-CONTENT-20260811-04`까지는 R3–R7 상세 **콘텐츠 설계** 승인이다. 어느 Decision도 실제 제품 구현을 열지 않는다.
...
`COLLECTOR_01 / ERSA_ROEN / EXHIBITION_EVIDENCE_AND_PROVENANCE`는 실제 작품 UID의 제작 증거 또는 살아온 이력을 전시 맥락에 맞춰 비교한다. 숨은 위신 총점이나 Chronicle 개수 최적화를 사용하지 않는다.

`EXHIBITION_RECEPTION_STATE / EXHIBIT_THESIS_FIT_STATE / ITEM_UID_PUBLIC_LEGACY_STATE`를 분리해 결과를 설명하고, 같은 UID를 후속 제작·복원·판매·재전시 이유로 되돌린다.