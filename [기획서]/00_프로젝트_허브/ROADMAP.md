...
CURRENT_STAGE_STATUS: R3_R7_5_OF_10_USER_APPROVED_PLANNING_ONLY
...
`BS-CONTENT-20260811-01`부터 `BS-CONTENT-20260811-05`까지는 R3–R7 상세 **콘텐츠 설계** 승인이다. 어느 Decision도 실제 제품 구현을 열지 않는다.
