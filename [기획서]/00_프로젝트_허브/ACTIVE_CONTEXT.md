...
- 정확한 반올림·상한·보정값은 `BASELINE_TEST_PRESET`
...
- 플레이어가 고객 능력과 사건 위험도를 비교해 성공 가능성이 높은 사람과 낮은 사람을 구분한다.
...
`BS-CUSTOMER-20260803-02`는 `BS-CUSTOMER-20260803-01`을 폐기하지 않는다. 고객 능력·장비 적합성·결과 인과는 유지하고 판매 전 정보 공개 범위만 세분화한다.
