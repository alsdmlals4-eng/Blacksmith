...
- 범위 보호: 장편 고객 퀘스트가 제작·강화보다 긴 필수 콘텐츠가 되는 확장 금지
- 역할 보호: GPT 논의는 핵심 재미·콘텐츠·이미지·아트 방향 중심
- 남은 설계 위험: 고객 관리 RPG 범위 팽창, 성공률 보정 불일치, 초기 콘텐츠 가족 간 시각·기계적 차별성 부족
...
- 현재 배치: `R2_BATCH_003 / 3_OF_10 / APPROVED_PENDING_MERGE`
...
2. 각 가족의 고객 동기·작품 상태·후속 제작 판단 차별화
3. 대표 콘텐츠 가족의 이미지·아트 시각 정체성 설계
